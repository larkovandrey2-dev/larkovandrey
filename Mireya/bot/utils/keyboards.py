...
def build_main_menu() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(text="🆘 SOS / МНЕ НУЖНА ПОМОЩЬ", callback_data="sos_info")
    )
...
def build_profile_menu() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(text="Добавить контакт на случай SOS", callback_data="lk_set_sos")
    )
    builder.row(
...
def build_back_button(callback_data: str = "main_menu", help=0) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
